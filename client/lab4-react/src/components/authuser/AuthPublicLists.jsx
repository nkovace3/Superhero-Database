...
const AuthPublicLists = () => {
  ...
  const submitReview = async (listName) => {
    try {
      ...
      // Step 4: Make an API call to update the database with the new review
      ...
      // You may want to fetch the updated data after submitting a review
      fetchRecentPublicLists(displayName);
                ...
                <>
                  ...
                  {list.heroInfo &&
                        ...
                        <div>
                            ...
                            />
                            <button onClick={() => submitReview(list.list_name)}>Submit Review</button>
                        </div>
                </>
              }
            />
